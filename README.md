...
For the remote repository, make a github repository named HW1_kchouse, then do;

```bash
git remote add origin git@github.com:JessLTaylor/HW1_kchouse.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── HW1_kchouse	<- Your notebooks and scripts will live in the main project folder
